      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav ms-auto">
            ...
            <router-link :to="{ name: 'AddCourse' }" class="nav-link" v-if="user.isAdmin">Add Course</router-link>
            <router-link :to="{name: 'Logout'}" class="nav-link" v-if="user.email">Logout</router-link>
          </div>
        </div>
      </div>
    </nav>
